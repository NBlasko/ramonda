...
Give the component the item as a prop. If the rows are replaced by fresh objects and you want a
key, it goes on the component — not on a tag inside it, which the row's own render owns:
