 ...
 * inside the build — the same bargain `build-css-properties.mjs` makes with `mdn-data`, one step
 * further out.
 *
...
console.log(`[prefixed] wrote ${names.length} names to ${file.replace(`${HERE}/../`, "")}`);
