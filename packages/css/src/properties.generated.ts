...
import type { CssDimension, CssLengthUnit, CssTimeUnit } from "./units.generated";
...
export interface CssProperties {
  /** `-apple-pay-button-style` — a vendor-prefixed property, from the engine's own list. */
  "-apple-pay-button-style": CssValue;
  /** `-apple-pay-button-type` — a vendor-prefixed property, from the engine's own list. */
  "-apple-pay-button-type": CssValue;
  /**
   ...
   * Status: nonstandard.
   */
  "-moz-binding": CssValue;
  /**
   * `-moz-border-bottom-colors` — `<color>+ | none`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-border-bottom-colors": CssValue;
  /**
   * `-moz-border-left-colors` — `<color>+ | none`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-border-left-colors": CssValue;
  /**
   * `-moz-border-right-colors` — `<color>+ | none`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-border-right-colors": CssValue;
  /**
   * `-moz-border-top-colors` — `<color>+ | none`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-border-top-colors": CssValue;
  /** `-moz-box-align` — a vendor-prefixed property, from the engine's own list. */
  "-moz-box-align": CssValue;
  /** `-moz-box-direction` — a vendor-prefixed property, from the engine's own list. */
  "-moz-box-direction": CssValue;
  /** `-moz-box-flex` — a vendor-prefixed property, from the engine's own list. */
  "-moz-box-flex": CssValue;
  /** `-moz-box-ordinal-group` — a vendor-prefixed property, from the engine's own list. */
  "-moz-box-ordinal-group": CssValue;
  /** `-moz-box-orient` — a vendor-prefixed property, from the engine's own list. */
  "-moz-box-orient": CssValue;
  /** `-moz-box-pack` — a vendor-prefixed property, from the engine's own list. */
  "-moz-box-pack": CssValue;
  /**
   * `-moz-context-properties` — `none | [ fill | fill-opacity | stroke | stroke-opacity ]#`
   * Initial: `none`. Inherited: yes.
   * Status: nonstandard.
   */
  "-moz-context-properties": CssValue;
  /**
  ...
  "-moz-osx-font-smoothing": CssValue;
  /**
   * `-moz-outline-radius` — `<outline-radius>{1,4} [ / <outline-radius>{1,4} ]?`
   * Initial: `-moz-outline-radius-topleft, -moz-outline-radius-topright, -moz-outline-radius-bottomright, -moz-outline-radius-bottomleft`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-outline-radius": CssValue;
  /**
   * `-moz-outline-radius-bottomleft` — `<outline-radius>`
   * Initial: `0`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-outline-radius-bottomleft": CssValue;
  /**
   * `-moz-outline-radius-bottomright` — `<outline-radius>`
   * Initial: `0`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-outline-radius-bottomright": CssValue;
  /**
   * `-moz-outline-radius-topleft` — `<outline-radius>`
   * Initial: `0`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-outline-radius-topleft": CssValue;
  /**
   * `-moz-outline-radius-topright` — `<outline-radius>`
   * Initial: `0`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-outline-radius-topright": CssValue;
  /**
   * `-moz-stack-sizing` — `ignore | stretch-to-fit`
   * Initial: `stretch-to-fit`. Inherited: yes.
   * Status: nonstandard.
   */
  "-moz-stack-sizing": Keyword<"ignore" | "stretch-to-fit">;
  /**
   * `-moz-text-blink` — `none | blink`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-text-blink": Keyword<"none" | "blink">;
  /** `-moz-text-size-adjust` — a vendor-prefixed property, from the engine's own list. */
  "-moz-text-size-adjust": CssValue;
  /**
   ...
   * Initial: `drag`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-window-dragging": Keyword<"drag" | "no-drag">;
  /**
   * `-moz-window-shadow` — `default | menu | tooltip | sheet | none`
   * Initial: `default`. Inherited: no.
   * Status: nonstandard.
   */
  "-moz-window-shadow": Keyword<"default" | "menu" | "tooltip" | "sheet" | "none">;
  /**
   * `-ms-accelerator` — `false | true`
   * Initial: `false`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-accelerator": Keyword<"false" | "true">;
  /**
   * `-ms-block-progression` — `tb | rl | bt | lr`
   * Initial: `tb`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-block-progression": Keyword<"tb" | "rl" | "bt" | "lr">;
  /**
   * `-ms-content-zoom-chaining` — `none | chained`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-content-zoom-chaining": Keyword<"none" | "chained">;
  /**
   * `-ms-content-zoom-limit` — `<'-ms-content-zoom-limit-min'> <'-ms-content-zoom-limit-max'>`
   * Initial: `-ms-content-zoom-limit-max, -ms-content-zoom-limit-min`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-content-zoom-limit": CssValue;
  /**
   * `-ms-content-zoom-limit-max` — `<percentage>`
   * Initial: `400%`. Inherited: no.
   * Status: nonstandard.
   */
   ...
   * Initial: `-ms-content-zoom-snap-type, -ms-content-zoom-snap-points`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-content-zoom-snap": CssValue;
  /**
   * `-ms-content-zoom-snap-points` — `snapInterval( <percentage>, <percentage> ) | snapList( <percentage># )`
   * Initial: `snapInterval(0%, 100%)`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-content-zoom-snap-points": CssValue;
  /**
   * `-ms-content-zoom-snap-type` — `none | proximity | mandatory`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-content-zoom-snap-type": Keyword<"none" | "proximity" | "mandatory">;
  /**
   * `-ms-content-zooming` — `none | zoom`
   * Initial: `zoomForTheTopLevelNoneForTheRest`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-content-zooming": Keyword<"none" | "zoom">;
  /**
   * `-ms-filter` — `<string>`
   * Initial: `""`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-filter": CssValue;
  /**
   ...
   * Status: nonstandard.
   */
  "-ms-flow-from": CssValue;
  /**
   * `-ms-flow-into` — `[ none | <custom-ident> ]#`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-flow-into": CssValue;
  /**
   * `-ms-grid-columns` — `none | <track-list> | <auto-track-list>`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-grid-columns": CssValue;
  /**
   * `-ms-grid-rows` — `none | <track-list> | <auto-track-list>`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-grid-rows": CssValue;
  /**
   * `-ms-high-contrast-adjust` — `auto | none`
   * Initial: `auto`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-high-contrast-adjust": Keyword<"auto" | "none">;
  /**
   * `-ms-hyphenate-limit-chars` — `auto | <integer>{1,3}`
   * Initial: `auto`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-hyphenate-limit-chars": CssValue;
  /**
   ...
   * Status: nonstandard.
   */
  "-ms-hyphenate-limit-zone": CssValue;
  /**
   * `-ms-ime-align` — `auto | after`
   * Initial: `auto`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-ime-align": Keyword<"auto" | "after">;
  /**
   * `-ms-overflow-style` — `auto | none | scrollbar | -ms-autohiding-scrollbar`
   * Initial: `auto`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-overflow-style": CssValue;
  /**
   * `-ms-scroll-chaining` — `chained | none`
   * Initial: `chained`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-chaining": Keyword<"chained" | "none">;
  /**
   * `-ms-scroll-limit` — `<'-ms-scroll-limit-x-min'> <'-ms-scroll-limit-y-min'> <'-ms-scroll-limit-x-max'> <'-ms-scroll-limit-y-max'>`
   * Initial: `-ms-scroll-limit-x-min, -ms-scroll-limit-y-min, -ms-scroll-limit-x-max, -ms-scroll-limit-y-max`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-limit": CssValue;
  /**
   ...
   * Initial: `railed`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-rails": Keyword<"none" | "railed">;
  /**
   * `-ms-scroll-snap-points-x` — `snapInterval( <length-percentage>, <length-percentage> ) | snapList( <length-percentage># )`
   * Initial: `snapInterval(0px, 100%)`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-snap-points-x": CssValue;
  /**
   * `-ms-scroll-snap-points-y` — `snapInterval( <length-percentage>, <length-percentage> ) | snapList( <length-percentage># )`
   * Initial: `snapInterval(0px, 100%)`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-snap-points-y": CssValue;
  /**
   * `-ms-scroll-snap-type` — `none | proximity | mandatory`
   * Initial: `none`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-snap-type": Keyword<"none" | "proximity" | "mandatory">;
  /**
   * `-ms-scroll-snap-x` — `<'-ms-scroll-snap-type'> <'-ms-scroll-snap-points-x'>`
   * Initial: `-ms-scroll-snap-type, -ms-scroll-snap-points-x`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-snap-x": CssValue;
  /**
   * `-ms-scroll-snap-y` — `<'-ms-scroll-snap-type'> <'-ms-scroll-snap-points-y'>`
   * Initial: `-ms-scroll-snap-type, -ms-scroll-snap-points-y`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-snap-y": CssValue;
  /**
   * `-ms-scroll-translation` — `none | vertical-to-horizontal`
   * Initial: `none`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scroll-translation": Keyword<"none" | "vertical-to-horizontal">;
  /**
   ...
   * Initial: `ButtonText`. Inherited: yes.
   * Status: nonstandard.
   */
   ...
   * Initial: `Scrollbar`. Inherited: yes.
   * Status: nonstandard.
   */
   ...
   * Status: nonstandard.
   */
  "-ms-text-autospace": Keyword<"none" | "ideograph-alpha" | "ideograph-numeric" | "ideograph-parenthesis" | "ideograph-space">;
  /**
   * `-ms-touch-select` — `grippers | none`
   * Initial: `grippers`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-touch-select": Keyword<"grippers" | "none">;
  /**
   * `-ms-user-select` — `none | element | text`
   * Initial: `text`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-user-select": Keyword<"none" | "element" | "text">;
  /**
   * `-ms-wrap-flow` — `auto | both | start | end | maximum | clear`
   * Initial: `auto`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-wrap-flow": Keyword<"auto" | "both" | "start" | "end" | "maximum" | "clear">;
  /**
   ...
   * Initial: `wrap`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-wrap-through": Keyword<"wrap" | "none">;
  /** `-webkit-align-content` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-align-content": CssValue;
  /** `-webkit-align-items` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-align-items": CssValue;
  /** `-webkit-align-self` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-align-self": CssValue;
  /** `-webkit-animation` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation": CssValue;
  /** `-webkit-animation-delay` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-delay": CssValue;
  /** `-webkit-animation-direction` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-direction": CssValue;
  /** `-webkit-animation-duration` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-duration": CssValue;
  /** `-webkit-animation-fill-mode` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-fill-mode": CssValue;
  /** `-webkit-animation-iteration-count` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-iteration-count": CssValue;
  /** `-webkit-animation-name` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-name": CssValue;
  /** `-webkit-animation-play-state` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-play-state": CssValue;
  /** `-webkit-animation-timing-function` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-animation-timing-function": CssValue;
  /**
  ...
  "-webkit-backdrop-filter": CssValue;
  /** `-webkit-backface-visibility` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-backface-visibility": CssValue;
  /** `-webkit-background-clip` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-background-clip": CssValue;
  /** `-webkit-background-origin` — a vendor-prefixed property, from the engine's own list. */
  ...
  /** `-webkit-border-bottom-left-radius` — a vendor-prefixed property, from the engine's own list. */
  ...
  /** `-webkit-border-image` — a vendor-prefixed property, from the engine's own list. */
  ...
  /** `-webkit-border-top-right-radius` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-border-top-right-radius": CssValue;
  /** `-webkit-border-vertical-spacing` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-border-vertical-spacing": CssValue;
  /** `-webkit-box-align` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-align": CssValue;
  /** `-webkit-box-decoration-break` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-decoration-break": CssValue;
  /** `-webkit-box-direction` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-direction": CssValue;
  /** `-webkit-box-flex` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-flex": CssValue;
  /** `-webkit-box-flex-group` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-flex-group": CssValue;
  /** `-webkit-box-lines` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-lines": CssValue;
  /** `-webkit-box-ordinal-group` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-ordinal-group": CssValue;
  /** `-webkit-box-orient` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-orient": CssValue;
  /** `-webkit-box-pack` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-pack": CssValue;
  /**
  ...
  /** `-webkit-box-sizing` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-box-sizing": CssValue;
  /** `-webkit-clip-path` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-clip-path": CssValue;
  /** `-webkit-column-axis` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-axis": CssValue;
  /** `-webkit-column-break-after` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-break-after": CssValue;
  /** `-webkit-column-break-before` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-break-before": CssValue;
  /** `-webkit-column-break-inside` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-break-inside": CssValue;
  /** `-webkit-column-count` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-count": CssValue;
  /** `-webkit-column-fill` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-fill": CssValue;
  /** `-webkit-column-gap` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-gap": CssValue;
  /** `-webkit-column-progression` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-progression": CssValue;
  /** `-webkit-column-rule` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-rule": CssValue;
  /** `-webkit-column-rule-color` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-rule-color": CssValue;
  /** `-webkit-column-rule-style` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-rule-style": CssValue;
  /** `-webkit-column-rule-width` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-rule-width": CssValue;
  /** `-webkit-column-span` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-span": CssValue;
  /** `-webkit-column-width` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-column-width": CssValue;
  /** `-webkit-columns` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-columns": CssValue;
  /** `-webkit-cursor-visibility` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-cursor-visibility": CssValue;
  /** `-webkit-filter` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-filter": CssValue;
  /** `-webkit-flex` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-flex": CssValue;
  /** `-webkit-flex-basis` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-flex-basis": CssValue;
  /** `-webkit-flex-direction` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-flex-direction": CssValue;
  /** `-webkit-flex-flow` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-flex-flow": CssValue;
  /** `-webkit-flex-grow` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-flex-grow": CssValue;
  /** `-webkit-flex-shrink` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-flex-shrink": CssValue;
  /** `-webkit-flex-wrap` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-flex-wrap": CssValue;
  /** `-webkit-font-feature-settings` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-font-feature-settings": CssValue;
  /** `-webkit-font-kerning` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-font-kerning": CssValue;
  /** `-webkit-font-smoothing` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-font-smoothing": CssValue;
  /** `-webkit-hyphenate-character` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-hyphenate-character": CssValue;
  /** `-webkit-hyphenate-limit-after` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-hyphenate-limit-after": CssValue;
  /** `-webkit-hyphenate-limit-before` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-hyphenate-limit-before": CssValue;
  /** `-webkit-hyphenate-limit-lines` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-hyphenate-limit-lines": CssValue;
  /** `-webkit-hyphens` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-hyphens": CssValue;
  /** `-webkit-initial-letter` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-initial-letter": CssValue;
  /** `-webkit-justify-content` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-justify-content": CssValue;
  /** `-webkit-justify-items` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-justify-items": CssValue;
  /** `-webkit-line-align` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-line-align": CssValue;
  /** `-webkit-line-box-contain` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-line-box-contain": CssValue;
  /** `-webkit-line-break` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-line-break": CssValue;
  /**
  ...
  "-webkit-line-grid": CssValue;
  /** `-webkit-line-snap` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-line-snap": CssValue;
  /** `-webkit-locale` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-locale": CssValue;
  /** `-webkit-logical-height` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-logical-height": CssValue;
  /** `-webkit-logical-width` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-logical-width": CssValue;
  /** `-webkit-margin-after` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-margin-after": CssValue;
  /** `-webkit-margin-before` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-margin-before": CssValue;
  /** `-webkit-margin-end` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-margin-end": CssValue;
  /** `-webkit-margin-start` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-margin-start": CssValue;
  /**
   ...
   * Initial: `-webkit-mask-image, -webkit-mask-repeat, -webkit-mask-attachment, -webkit-mask-position, -webkit-mask-origin, -webkit-mask-clip`. Inherited: no.
   * Status: nonstandard.
   * @see https://developer.mozilla.org/docs/Web/CSS/mask
   */
  "-webkit-mask": CssValue;
  /**
   * `-webkit-mask-attachment` — `<attachment>#`
   * Initial: `scroll`. Inherited: no.
   * Status: nonstandard.
   */
  "-webkit-mask-attachment": CssValue;
  /** `-webkit-mask-box-image` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-mask-box-image": CssValue;
  /** `-webkit-mask-box-image-outset` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-mask-box-image-outset": CssValue;
  /** `-webkit-mask-box-image-repeat` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-mask-box-image-repeat": CssValue;
  /** `-webkit-mask-box-image-slice` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-mask-box-image-slice": CssValue;
  /** `-webkit-mask-box-image-source` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-mask-box-image-source": CssValue;
  /** `-webkit-mask-box-image-width` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-mask-box-image-width": CssValue;
  /**
  ...
  "-webkit-mask-source-type": CssValue;
  /** `-webkit-max-logical-height` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-max-logical-height": CssValue;
  /** `-webkit-max-logical-width` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-max-logical-width": CssValue;
  /** `-webkit-min-logical-height` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-min-logical-height": CssValue;
  /** `-webkit-min-logical-width` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-min-logical-width": CssValue;
  /** `-webkit-nbsp-mode` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-nbsp-mode": CssValue;
  /** `-webkit-opacity` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-opacity": CssValue;
  /** `-webkit-order` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-order": CssValue;
  /**
   * `-webkit-overflow-scrolling` — `auto | touch`
   * Initial: `auto`. Inherited: yes.
   * Status: nonstandard.
   */
  "-webkit-overflow-scrolling": Keyword<"auto" | "touch">;
  /** `-webkit-padding-after` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-padding-after": CssValue;
  /** `-webkit-padding-before` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-padding-before": CssValue;
  /** `-webkit-padding-end` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-padding-end": CssValue;
  /** `-webkit-padding-start` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-padding-start": CssValue;
  /** `-webkit-perspective` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-perspective": CssValue;
  /** `-webkit-perspective-origin` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-perspective-origin": CssValue;
  /** `-webkit-perspective-origin-x` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-perspective-origin-x": CssValue;
  /** `-webkit-perspective-origin-y` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-perspective-origin-y": CssValue;
  /** `-webkit-print-color-adjust` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-print-color-adjust": CssValue;
  /** `-webkit-rtl-ordering` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-rtl-ordering": CssValue;
  /** `-webkit-ruby-position` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-ruby-position": CssValue;
  /** `-webkit-shape-image-threshold` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-shape-image-threshold": CssValue;
  /** `-webkit-shape-margin` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-shape-margin": CssValue;
  /** `-webkit-shape-outside` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-shape-outside": CssValue;
  /**
  ...
  "-webkit-text-combine": CssValue;
  /** `-webkit-text-decoration` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-decoration": CssValue;
  /** `-webkit-text-decoration-color` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-decoration-color": CssValue;
  /** `-webkit-text-decoration-line` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-decoration-line": CssValue;
  /** `-webkit-text-decoration-skip` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-decoration-skip": CssValue;
  /** `-webkit-text-decoration-style` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-decoration-style": CssValue;
  /** `-webkit-text-decorations-in-effect` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-decorations-in-effect": CssValue;
  /** `-webkit-text-emphasis` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-emphasis": CssValue;
  /** `-webkit-text-emphasis-color` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-emphasis-color": CssValue;
  /** `-webkit-text-emphasis-position` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-emphasis-position": CssValue;
  /** `-webkit-text-emphasis-style` — a vendor-prefixed property, from the engine's own list. */
  ...
  "-webkit-text-orientation": CssValue;
  /** `-webkit-text-security` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-security": CssValue;
  /** `-webkit-text-size-adjust` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-size-adjust": CssValue;
  /**
  ...
  "-webkit-text-underline-position": CssValue;
  /** `-webkit-text-zoom` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-text-zoom": CssValue;
  /**
  ...
  /** `-webkit-transform-origin` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transform-origin": CssValue;
  /** `-webkit-transform-origin-x` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transform-origin-x": CssValue;
  /** `-webkit-transform-origin-y` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transform-origin-y": CssValue;
  /** `-webkit-transform-origin-z` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transform-origin-z": CssValue;
  /** `-webkit-transform-style` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transform-style": CssValue;
  /** `-webkit-transition` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transition": CssValue;
  /** `-webkit-transition-delay` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transition-delay": CssValue;
  /** `-webkit-transition-duration` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transition-duration": CssValue;
  /** `-webkit-transition-property` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transition-property": CssValue;
  /** `-webkit-transition-timing-function` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-transition-timing-function": CssValue;
  /** `-webkit-user-drag` — a vendor-prefixed property, from the engine's own list. */
  "-webkit-user-drag": CssValue;
  /**
   * `-webkit-user-modify` — `read-only | read-write | read-write-plaintext-only`
   * Initial: `read-only`. Inherited: yes.
   * Status: nonstandard.
   */
  "-webkit-user-modify": Keyword<"read-only" | "read-write" | "read-write-plaintext-only">;
  /**
  ...
  "glyph-orientation-vertical": CssValue;
  /**
  ...
  "mask-position-x": CssValue;
  /** `mask-position-y` — a vendor-prefixed property, from the engine's own list. */
  "mask-position-y": CssValue;
  /**
  ...
  "perspective-origin-x": CssValue;
  /** `perspective-origin-y` — a vendor-prefixed property, from the engine's own list. */
  "perspective-origin-y": CssValue;
  /**
  ...
  "transform-origin-x": CssValue;
  /** `transform-origin-y` — a vendor-prefixed property, from the engine's own list. */
  "transform-origin-y": CssValue;
  /** `transform-origin-z` — a vendor-prefixed property, from the engine's own list. */
  "transform-origin-z": CssValue;
  /**
