...
export interface CssArity {
  ...
  "corner-inline-end-shape": 1 | 2;
  "corner-inline-start-shape": 1 | 2;
  "corner-left-shape": 1 | 2;
  "corner-right-shape": 1 | 2;
  "corner-shape": 1 | 2 | 3 | 4;
  "corner-top-shape": 1 | 2;
  "fill-opacity": 1;
  "flood-opacity": 1;
  "gap": 1 | 2;
  "grid-gap": 1 | 2;
...
export interface CssProperties {
   ...
   * Status: nonstandard.
   */
  "-ms-content-zoom-limit-max": CssValue;
  /**
   * `-ms-content-zoom-limit-min` — `<percentage>`
   * Initial: `100%`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-content-zoom-limit-min": CssValue;
  /**
   ...
   * Status: nonstandard.
   */
  "-ms-hyphenate-limit-lines": CssValue;
  /**
   ...
   * Status: nonstandard.
   */
  "-ms-scroll-limit-x-max": CssValue;
  /**
   * `-ms-scroll-limit-x-min` — `<length>`
   * Initial: `0`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-limit-x-min": CssValue;
  /**
   * `-ms-scroll-limit-y-max` — `auto | <length>`
   * Initial: `auto`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-limit-y-max": CssValue;
  /**
   * `-ms-scroll-limit-y-min` — `<length>`
   * Initial: `0`. Inherited: no.
   * Status: nonstandard.
   */
  "-ms-scroll-limit-y-min": CssValue;
  /**
   ...
   * Status: nonstandard.
   */
  "-ms-scrollbar-3dlight-color": CssValue;
  /**
   * `-ms-scrollbar-arrow-color` — `<color>`
   * Initial: `ButtonText`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scrollbar-arrow-color": CssValue;
  /**
   * `-ms-scrollbar-base-color` — `<color>`
   * Initial: `dependsOnUserAgent`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scrollbar-base-color": CssValue;
  /**
   * `-ms-scrollbar-darkshadow-color` — `<color>`
   * Initial: `ThreeDDarkShadow`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scrollbar-darkshadow-color": CssValue;
  /**
   * `-ms-scrollbar-face-color` — `<color>`
   * Initial: `ThreeDFace`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scrollbar-face-color": CssValue;
  /**
   * `-ms-scrollbar-highlight-color` — `<color>`
   * Initial: `ThreeDHighlight`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scrollbar-highlight-color": CssValue;
  /**
   * `-ms-scrollbar-shadow-color` — `<color>`
   * Initial: `ThreeDDarkShadow`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scrollbar-shadow-color": CssValue;
  /**
   * `-ms-scrollbar-track-color` — `<color>`
   * Initial: `Scrollbar`. Inherited: yes.
   * Status: nonstandard.
   */
  "-ms-scrollbar-track-color": CssValue;
  /**
